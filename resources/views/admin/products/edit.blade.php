    ...
    <div class="card">
        ...
        <div class="form-row" style="grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
            <div class="form-group">
                ...
                <input type="number" name="price" class="form-control" step="0.01" value="{{ $page->price }}" placeholder="e.g. 2999.00">
            </div>
            <div class="form-group">
                <label>Discount Amount (₹)</label>
                <input type="number" name="discount" class="form-control" step="0.01" value="{{ $page->discount }}" placeholder="e.g. 300.00">
            </div>
            <div class="form-group">
