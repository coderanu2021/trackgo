        ...
        <div style="display: grid; gap: 1.5rem; align-content: start;">
            <div class="card">
                ...
                <div class="form-group" style="display: flex; align-items: center; gap: 0.5rem;">
                    <input type="checkbox" name="is_published" id="is_published" value="1" checked style="width: 1.1rem; height: 1.1rem; cursor: pointer;">
                    <label for="is_published" style="font-weight: 500; cursor: pointer;">Publish immediately</label>
                </div>
