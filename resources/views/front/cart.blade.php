    ...
    <div style="background: white; border-radius: var(--radius-lg); border: 1px solid var(--border); overflow: hidden; box-shadow: var(--shadow-md);">
            ...
            <tbody>
                ...
                @forelse($cart as $id => $details)
                    ...
                    <tr style="border-bottom: 1px solid var(--border);">
                        ...
                        <td style="padding: 2rem; font-family: 'Outfit', sans-serif; font-weight: 700; color: var(--secondary);">₹{{ formatIndianPrice($details['price'], 2) }}</td>
                        <td style="padding: 2rem;">
                        ...
                        <td style="padding: 2rem; font-family: 'Outfit', sans-serif; font-weight: 800; color: var(--primary); font-size: 1.15rem;">₹{{ formatIndianPrice($details['price'] * $details['quantity'], 2) }}</td>
        ...
        <div style="padding: 3rem; background: var(--bg-light); border-top: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="text-align: right;">
                ...
                <div style="font-family: 'Outfit', sans-serif; font-size: 2.5rem; font-weight: 800; color: var(--secondary); margin-bottom: 2rem;">₹{{ formatIndianPrice($total, 2) }}</div>
