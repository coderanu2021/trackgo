...
class CurrencyHelper
{
     ...
     * @return string
     */
    public static function formatIndianPrice($amount, $decimals = 2)
    {
     ...
     * @return string
     */
    public static function formatPrice($amount, $decimals = 2, $symbol = '₹')
    {
        return $symbol . self::formatIndianPrice($amount, $decimals);
    }
}