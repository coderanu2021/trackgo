...
class AdminController extends Controller
{
    public function dashboard()
    {
        $stats = [
            ...
            'products' => \App\Models\Page::count(),
            'pages' => \App\Models\ProductPage::count(),
        ...
        $pages = \App\Models\ProductPage::latest()->take(5)->get();

        return view('admin.dashboard', compact('stats', 'recent_orders', 'recent_blogs', 'pages'));
    }
}
